...
export class HeroService {
    ...
    // método que nos va a ayudar a obtener la informacion de todo el array de heroes
    public getHeros(){
        return this.Heros;
    }
    ...
    public searchHeros(termino){
      ...
      // usar un ciclo para comparar el termino de búsqueda contra la propiedad nombre de cada heroe
